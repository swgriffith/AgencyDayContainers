...
3. Test web app
    ...
    The jumpbox has a Public IP address and port 8080 is open. You can browse your running app with a link such as: http://[vmname].[region].cloudapp.azure.com:8080/#/ 
